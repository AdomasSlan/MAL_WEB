...
if (isset($_COOKIE["code"])) {
    ...
    curl_setopt($ch, CURLOPT_URL, "https://api.myanimelist.net/v2/manga/ranking?ranking_type=$Type&limit=500&fields=mean,media_type,alternative_titles,my_list_status");
