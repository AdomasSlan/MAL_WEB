...
if (isset($_COOKIE["code"])) {
    ...
    curl_setopt($ch, CURLOPT_URL, "https://api.myanimelist.net/v2/users/@me/mangalist?status=$Status&fields=list_status,mean,media_type,alternative_titles&sort=list_score&limit=100" );
