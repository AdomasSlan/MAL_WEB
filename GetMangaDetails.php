...
if (isset($_COOKIE["code"])) {
    ...
    curl_setopt($ch, CURLOPT_URL, "https://api.myanimelist.net/v2/manga/$MangaID?fields=rank,alternative_titles,synopsis,media_type,my_list_status,mean,rank,start_date,end_date,authors{first_name,last_name}");
    ...
    echo "                    <option>plan_to_read</option>";
    echo "                    </select>";
    echo "                    </td>";
    echo "                </tr>";
    echo "                <tr>";
    ...
    echo "                <tr>";
    echo "                <td>";
    echo "                <button class='btn btn-success' onclick='UpdateMyList(" . $server_output['id'] .",\"manga\")'>Update</button>";
    echo "                </td>";
    echo "                <td>";
    echo "                <button class='btn btn-danger' onclick='DeleteFromList(" . $server_output['id'] .",\"manga\")'>Delete</button>";
    echo "                </td>";
    echo "                </tr>";
    echo "            </table>";
    echo "        </td>";
    ...
    echo "        <td>";
    echo "            <table>";
    foreach ($server_output["authors"] as $count) {
        echo"<tr>";
        echo "        <td>".$count["node"]["first_name"]." ".$count["node"]["last_name"]." ".$count["role"]."</td>";
        echo "</tr>";
    }
    echo "            </table>";
    echo "        </td>";
